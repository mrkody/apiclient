...
if (!function_exists('curl_init')) {
    throw new Exception('API Class needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
    throw new Exception('API Class needs the JSON PHP extension.');
}
...
class DiCMSApiClient {
    ...
    const ERROR_CSCART_API_MESSAGE = 'Message from API: ';
    ...
    public function __construct($config) {
        $this->setUserLogin($config['login']);
    ...
    protected function makeRequest($objectUrl, $method, $data = '', $params = array()) {
        ...
        //echo($this->initUrl($objectUrl, $params));
    ...
    protected function initUrl( $objectUrl, array $params = array() )
    {
        //print_r($params);
